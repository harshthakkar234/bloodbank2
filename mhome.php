...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div id="logo"><a href="index1.html"><img src="images/logo1.png" alt="Conmpany Name"></a></div>
    </div>
  ...
  <section class="top-bar-section">
    ...
    <ul class="right">
      ...
      <li><a href="mreg.php">Register</a></li>
...
<p>Study buddy is a website that will help you study and take notes shared by engineering students of mumbai university.</p>
    <p> This website would help you to study the notes made by students themselves, during classes or exams, which is the easiest way to study rather from textbooks..
     No need of codes, completely free of cost, we are here to help each other</p>
 ...
 <h3> Uploading</h3>
 <p> This feature helps you to upload the notes of any subject that you have.</p>
 </div>
 </div>
 ...
 <div class="txt-box text-center">
 <h3>Downloading</h3>
 <p>This feature will help you download the file of notes uploaded by other students using this website.</p>
 </div>
 </div>
